...
def train(to_index=6714, checkpoint_name='ppo_portfolio'):
...
def infer(from_index=6714, checkpoint_name='ppo_portfolio'):
...
def main(istrain=False, isinfer=False, checkpoint_name='ppo_portfolio', split=6714):
    if istrain:
        train(to_index=split, checkpoint_name=checkpoint_name)
    if isinfer:
        infer(from_index=split, checkpoint_name=checkpoint_name)
